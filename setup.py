...
setuptools.setup(
    ...
    version=md.version,
    description=(
        "Command-line program for importing the Physiome model repository into BioSimulations."
    ),
    long_description=md.long_description,
    url="https://github.com/biosimulations/biosimulations-physiome",
    download_url='https://github.com/biosimulations/biosimulations-physiome',
    ...
    entry_points={
        'console_scripts': [
            'biosimulations-physiome = biosimulations_physiome.__main__:main',
        ],
    },
)