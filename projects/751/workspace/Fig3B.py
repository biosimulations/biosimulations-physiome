...
#   cd [PathToThisFile]
#   [PathToOpenCOR]/pythonshell Figure3B.py
...
result = []
q_Cl_i_vec = [0,5,10,15,20,25,30,35,40,45,50,60,70,80,90,100,110,120]
for q in q_Cl_i_vec:
...
for q in q_Cl_i_vec:
    ...
    data1.states()["concentrations/Cl_int"] = q
    simulation1.run()
...
plt.plot(q_Cl_i_vec, result, color= 'green')
plt.plot(q_Cl_i_vec, result_cellml, color= 'blue')
plt.xlabel('Cl$_i$')
