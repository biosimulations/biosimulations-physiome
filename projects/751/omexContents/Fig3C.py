...
#   cd [PathToThisFile]
#   [PathToOpenCOR]/pythonshell Figure3C.py
...
result = []
q_HCO3_o_vec = [0,5,10,15,20,25,30,35,40,45,50,60,70,80,90,100,110,120]
for q in q_HCO3_o_vec:
...
for q in q_HCO3_o_vec:
    ...
    data1.states()["concentrations/HCO3_ext"] = q
    simulation1.run()
...
plt.plot(q_HCO3_o_vec, result, color= 'green')
plt.plot(q_HCO3_o_vec, result_cellml, color= 'blue')
plt.ylim()
plt.xlabel('HCO3_o')
