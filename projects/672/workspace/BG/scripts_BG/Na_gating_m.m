...
error_func = @(params) 10.*error_func_alpha(params) + error_func_beta(params) + 1000000.* error_func_gss(params) + 700000.* error_func_tau(params);
lb = [0; -10; 0; -10];
ub = [Inf; 10; Inf; 10];
...
save(['Na_m_parameters.mat'],'params_vec','alpha','beta','g_ss','tau','alpha_bg','beta_bg','g_ss_bg','tau_bg','V','MSE');
%% Plot for comparison
h = figure;
x0=100;
y0=50;
...
gate_plot(alpha,beta,g_ss,tau,alpha_bg,beta_bg,g_ss_bg,tau_bg,V,'m',MSE);
filename='gate_m';
